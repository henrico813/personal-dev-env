...
The terminal profile uses only the listed paths needed for its Ubuntu packages,
tmux, Aqua tools, terminal shell/tmux configuration, state, and config. The
full profile manages all paths in this table. The installer checks that managed destinations
