---
description: Create a technical design document for a feature, system, or architectural change
argument-hint: "[topic or feature to design]"
allowed-tools: Bash(git log:*), Bash(git diff:*), Write, Edit
---
