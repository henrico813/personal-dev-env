# Generated by Powerlevel10k configuration wizard on 2025-06-22 at 22:13 UTC.
...
() {
  ...
  ##################################[ dir: current directory ]##################################
  typeset -g POWERLEVEL9K_DIR_FOREGROUND=111          # Tokyo blue
  typeset -g POWERLEVEL9K_DIR_BACKGROUND=235          # Tokyo dark bg
  typeset -g POWERLEVEL9K_DIR_SHORTENED_FOREGROUND=244 # Tokyo gray
  typeset -g POWERLEVEL9K_DIR_ANCHOR_FOREGROUND=117   # Tokyo cyan
  ...
  typeset -g POWERLEVEL9K_VCS_FOREGROUND=235          # Tokyo blue
  typeset -g POWERLEVEL9K_VCS_BACKGROUND=111         # Tokyo dark bg
  ...
  function my_git_formatter() {
    ...
    local conflicted='%9F' # bright red foreground
  ...
  typeset -g POWERLEVEL9K_STATUS_OK_FOREGROUND=107    # Tokyo green
  typeset -g POWERLEVEL9K_STATUS_ERROR_FOREGROUND=210 # Tokyo red
  ...
  typeset -g POWERLEVEL9K_TIME_BACKGROUND=111
