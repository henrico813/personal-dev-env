...
- `pde-installer/test/`: direct fixture smoke and Docker installer tests.
...
- Run Go tests, vet, shell syntax checks, `./pde-installer/test/verify-ci-smoke.sh`, and `./pde-installer/test/run-tests.sh smoke` after installer changes.
