...
| Supplied input | `ai/skills/supplied-input/` | `~/.agents/skills/supplied-input/`, `~/.codex/skills/supplied-input/` | Start workflows from input already present in a request |
